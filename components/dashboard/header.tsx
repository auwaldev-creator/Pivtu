  ...
  return (
    <header className="flex items-center justify-between px-4 py-3">
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={onMenuClick}
          className="rounded-xl p-2 transition-colors hover:bg-secondary active:scale-95"
        >
      ...
      <div className="flex items-center gap-1">
        ...
        <button className="rounded-xl p-2.5 transition-all hover:bg-secondary active:scale-95">
